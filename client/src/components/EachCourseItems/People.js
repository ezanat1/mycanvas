...
export default class People extends Component {
  ...
  render() {
    ...
    // let eachPeople = null;
    // eachPeople = this.state.people.map(singlePeople => {
    //   console.log(singlePeople.first_name);

    //   return (
    //     <tr key={singlePeople.id}>
    //       <td>{singlePeople.first_name}</td>
    //       <td>{singlePeople.last_name}</td>
    //       <td>{singlePeople.email}</td>
    //     </tr>
    //   );
    // });
    let eachPeople = null;
